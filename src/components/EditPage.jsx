...
function EditPage({setImages}) {
    ...
    const selectMargin = () => {
        ...
        console.log(dispatch(setImageMargin(inputValue)));
    }
    ...
    return (
        <div className='border-b-2 mb-2'>
            <div className='h-[45px]  w-[77%] flex my-2 items-center '>
                ...
                <div className={'ml-3 '}>
                    <input type={"number"} min={0.5} max={10} className={'text-black '} value={inputValue} onChange={(e) =>setInputValue(e.target.value)} step={0.5}  />
                    <button type={"submit"} className={'text-black'} onClick={selectMargin}>Set Margin</button>
